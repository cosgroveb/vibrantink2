...
" Keyword    ctermfg=202   OrangeRed1	#ff5f00
" Define     ctermfg=202
" Comment    ctermfg=98    MediumPurple3	#875fd7
" Type       ctermfg=White
" rubySymbol ctermfg=66    PaleTurquoise4	#5f8787
" Identifier ctermfg=White
" rubyStringDelimiter ctermfg=82 Chartreuse2	#5fff00
" rubyInterpolation ctermfg=White
" rubyPseudoVariable ctermfg=66
" Constant   ctermfg=228   Khaki1	#ffff87
" Function   ctermfg=220   Gold1	#ffd700
" Include    ctermfg=220
" Statement  ctermfg=202
" String     ctermfg=82
" Search     ctermbg=White
" CursorLine cterm=NONE ctermbg=235 Grey15	#262626
...
if has("gui_running")
    ...
    "hi SpellBad ctermbg=NONE ctermfg=NONE cterm=undercurl guibg=NONE guifg=#af5f5f gui=undercurl guisp=#af5f5f
    hi SpellCap ctermbg=NONE ctermfg=NONE cterm=undercurl guibg=NONE guifg=#5fafaf gui=undercurl guisp=#5fafaf
    "hi SpellLocal ctermbg=NONE ctermfg=NONE cterm=undercurl guibg=NONE guifg=#5f875f gui=undercurl guisp=#5f875f
    "hi SpellRare ctermbg=NONE ctermfg=NONE cterm=undercurl guibg=NONE guifg=#ff8700 gui=undercurl guisp=#ff8700
endif
